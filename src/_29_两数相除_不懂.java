public class _29_两数相除_不懂 {

    public static void main(String[] args) {
        System.out.println(divide(10,-3));
    }

    static public long divide(int dividend, int divisor) {
    ...
    static public long div(long a, long b){  // 似乎精髓和难点就在于下面这几句
        if(a<b) return 0;
        long count = 1;
        ...
        return (count + div(a-tb,b));//剩余的值继续递归
    }
}
